...
// Biểu đồ Top N không còn hợp lý nếu Leaderboard có phân trang đầy đủ.
// Nếu vẫn muốn giữ, nó chỉ nên hiển thị dữ liệu của trang hiện tại, hoặc cần một API riêng cho Top N tổng thể.
// Tạm thời sẽ comment out để tập trung vào bảng phân trang.
