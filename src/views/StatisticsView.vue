...
<template>
  <div class="statistics-view py-4">
    ...
    <div v-if="isLoadingSummary" class="text-center my-3"><div class="spinner-border text-secondary"></div><p>Loading summary...</p></div>
    ...
    <div class="row gy-4">
      <div class="col-lg-6">
        <div class="card shadow-sm h-100">
          <div class="card-header"><h5 class="mb-0">Player Elo Distribution</h5></div>
      ...
      <div class="col-lg-6">
        <div class="card shadow-sm h-100">
          <div class="card-header"><h5 class="mb-0">Average KDA by Role</h5></div>
          <div class="card-body d-flex align-items-center justify-content-center">
      ...
      <div class="col-lg-6">
        <div class="card shadow-sm h-100">
          <div class="card-header"><h5 class="mb-0">Average CS by Role</h5></div>
          <div class="card-body d-flex align-items-center justify-content-center">
            <div v-if="isLoadingAvgStatsByRole" class="text-center"><div class="spinner-border"></div></div>
            <div v-else-if="avgStatsByRoleError" class="alert alert-danger w-100">{{ avgStatsByRoleError }}</div>
      ...
      <div class="col-lg-6">
        <div class="card shadow-sm h-100">
          <div class="card-header"><h5 class="mb-0">Average Gold by Role</h5></div>
          <div class="card-body d-flex align-items-center justify-content-center">
            <div v-if="isLoadingAvgStatsByRole" class="text-center"><div class="spinner-border"></div></div>
            <div v-else-if="avgStatsByRoleError" class="alert alert-danger w-100">{{ avgStatsByRoleError }}</div>
      ...
      <div class="col-lg-6">
        <div class="card shadow-sm h-100">
          <div class="card-header"><h5 class="mb-0">Top 15 Champion Pick Rates (%)</h5></div>
          <div class="card-body d-flex align-items-center justify-content-center">
      ...
      <div class="col-lg-6">
        <div class="card shadow-sm h-100">
          <div class="card-header"><h5 class="mb-0">Top 15 Champion Win Rates (%) <small class="text-muted fw-normal">(min. 10 games)</small></h5></div>
          <div class="card-body d-flex align-items-center justify-content-center">
